...
function calculateSolarEstimate({ monthlyBill, dailyUsage, roofArea, systemCost, downPayment, loanYears, interestRate, batterySize, essentialLoad, brownoutHours }) {
  ...
  const systemKw = Math.min(20, Math.max(1.5, safeMonthlyBill / 1650));
...
export default function ZEERSolarLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
      <header className="sticky top-0 z-50 border-b border-slate-100 bg-white/95 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-10">
          ...
          <nav className="hidden items-center gap-9 text-sm font-semibold text-slate-700 lg:flex">
            <a className="border-b-2 border-blue-600 pb-1 text-blue-700" href="#home">Home</a>
            <a className="hover:text-blue-700" href="#tools">Solutions</a>
            <a className="hover:text-blue-700" href="#how">How It Works</a>
            <a className="hover:text-blue-700" href="#about">About Us</a>
            <a className="hover:text-blue-700" href="#contact">Contact</a>
          </nav>
          <button className="rounded-xl bg-blue-700 px-5 py-3 text-sm font-bold text-white shadow-lg shadow-blue-700/25 transition hover:bg-blue-800">
            Get Free Estimate
          </button>
        </div>
      </header>
      ...
      <main id="home">
        <section className="relative overflow-hidden bg-gradient-to-br from-white via-sky-50 to-white">
          <div className="absolute inset-y-0 right-0 hidden w-[58%] lg:block">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(253,186,116,0.55),transparent_28%),linear-gradient(115deg,rgba(255,255,255,0.95)_0%,rgba(255,255,255,0.55)_34%,rgba(255,255,255,0)_58%)]" />
          ...
          <div className="relative mx-auto grid max-w-7xl gap-10 px-6 py-16 lg:grid-cols-[0.95fr_1.05fr] lg:px-10 lg:py-24">
            <div className="max-w-xl">
              ...
              <div className="mt-9 flex flex-col gap-4 sm:flex-row">
                <a href="#tools" className="inline-flex items-center justify-center rounded-xl bg-blue-700 px-7 py-4 text-base font-bold text-white shadow-xl shadow-blue-700/25 transition hover:bg-blue-800">
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              <ToolCard color="blue" icon="panel" title="Smart Solar Estimator" subtitle="Get an instant estimate for your solar system.">
                ...
                <p className="mt-4 text-center text-xs text-slate-500">*Results are estimates only. Final proposal may vary.</p>
              </ToolCard>
        ...
        <section id="about" className="relative overflow-hidden bg-blue-950 px-6 py-20 text-white lg:px-10">
          ...
          <div className="mx-auto max-w-5xl text-center">
            ...
            <a href="#tools" className="mt-8 inline-flex rounded-xl bg-green-500 px-8 py-4 font-bold text-white shadow-xl shadow-green-500/20 transition hover:bg-green-600">
              Try the Smart Tools
            </a>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-5xl">
            ...
            <div className="mt-10 grid gap-8 md:grid-cols-3">
              ...
              <div className="text-center">
                ...
                <p className="mt-2 text-slate-600">info@zeersolar.com</p>
              </div>
              <div className="text-center">
                <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-blue-100 text-blue-700">
                  <Icon name="map" />
                ...
                <p className="mt-2 text-slate-600">Cebu City, Philippines</p>
              </div>
            </div>
          </div>
        </section>
